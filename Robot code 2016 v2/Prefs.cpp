...
void Prefs::PrefsInit() {
	...
	prefs->PutInt("frontLeftMotorCANTalonID", 2);
	prefs->PutInt("backRightMotorCANTalonID", 3);
	prefs->PutInt("backLeftMotorCANTalonID", 4);
	prefs->PutInt("collectConveyorMotorCANTalonID", 5);
	prefs->PutInt("collectArmMotorCANTalonID", 6);
	prefs->PutInt("liftMotorCANTalonID", 7);
	prefs->PutInt("shooterTopMotorCANTalonID", 8);
	prefs->PutInt("shooterBottomMotorCANTalonID", 9);
